...
test_expect_success 'prefetch respects single and multiple remote.<name>.prefetchref patterns' '
    ...
    (
        ...
        git config remote.remote1.prefetchref "refs/heads/main" &&
        ...
        # Verify that only specified refs are in the prefetch refs for remote1
         git rev-parse refs/prefetch/remotes/remote1/main &&
...
#        # Verify that only specified refs are in the prefetch refs for remote2
        ...
        git fetch --all &&
        test_cmp_rev refs/remotes/remote1/main refs/prefetch/remotes/remote1/main &&
